...
import { registerModerator, clearError } from '../store/slices/authSlice';
...
function ModeratorRegister() {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            await dispatch(registerModerator({
            ...
            toast.error(err || 'Moderator registration failed. Please try again.');
        }
    };
        ...
        <div className="page-container" style={{ maxWidth: '500px', margin: '0 auto' }}>
            <div className="card">
                <div className="text-center mb-lg">
                    ...
                    <h1 style={{ fontSize: '2rem', marginBottom: '0.5rem' }}>Register New Moderator</h1>
